...
urlpatterns = patterns('',
    ...
    url(r'^chat_oneonone/connected', views.connected_oneonone),
    url(r'^chat_empire/connected', views.connected_empire),
    url(r'^chat_oneonone/list', views.list_oneonone),
    url(r'^chat_empire/list', views.list_empire),
